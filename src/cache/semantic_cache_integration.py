...
try:
    ...
    from .optimized_rag_cache import OptimizedRAGCache
except ImportError:
    # Fallback para desenvolvimento
    SemanticSimilarityCache = None
    OptimizedRAGCache = None
...
class IntegratedCacheSystem:
    ...
    def __init__(self,
        ...
        if enable_traditional and OptimizedRAGCache:
            try:
                self.traditional_cache = OptimizedRAGCache(traditional_cache_config)
                logger.info("✅ Cache tradicional (otimizado) inicializado")
            except Exception as e:
